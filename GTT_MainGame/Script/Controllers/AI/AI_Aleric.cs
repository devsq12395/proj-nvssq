...
public class AI_Aleric : MonoBehaviour
{
	public static AI_Aleric I;
	...
	public void useAbility(MG_ClassUnit current){
		...
		if(hasTarget && current.MP >= 50){
			if (enemyCount >= 2) {
				...
				MG_ControlCommand.I.gameAction_aleric_axeThrow(current, target.posX, target.posY, "AxeThrow", 50);
				#endregion
			}
		}
